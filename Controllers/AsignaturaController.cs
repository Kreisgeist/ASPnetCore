...
namespace ASP_.NET_Core.Controllers
{
    public class AsignaturaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await escuelaContext.OrderByDescending(a => a.CursoId).ToListAsync());
        }
        ...
        {
            ViewData["CursoId"] = new SelectList(_context.Cursos.OrderByDescending(c => c.Nombre), "Id", "Nombre");
            return View();
        }

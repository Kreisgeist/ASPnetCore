...
namespace ASP_.NET_Core.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await escuelaContext.OrderBy(e => e.CursoId).ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["CursoId"] = new SelectList(_context.Cursos.OrderBy(c => c.Nombre), "Id", "Nombre", alumno.CursoId);
            return View(alumno);
        }
